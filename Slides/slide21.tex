...
%    \tikz \draw [arrows = {-Stealth[length=10pt, inset=5pt]}] (0,0) -- (1,0);
    \begin{textblock*}{1cm}(58mm, 28mm)
        \tikz [line width=1mm]\draw [arrows = {-Stealth[length=10pt]}] (0,0) -- (1,0);
    \end{textblock*}

    \begin{textblock*}{5cm}(65mm, 17mm)
        \centering
        \includegraphics[width=0.7\textwidth]{vddMgndManuscrit.pdf}
    \end{textblock*}

    \begin{textblock*}{1cm}(110.6mm, 33.65mm)
        \tikz [line width=1mm]\draw [arrows = {-Stealth[length=10pt]}] (0,0) -- (0.6,-1);
    \end{textblock*}
