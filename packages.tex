...
\documentclass[table, cmyk, dvipsnames, 11pt]{book}
\pdfoutput=1
...
\definecolor{myViolet2}{RGB}{178, 32, 214}
\definecolor{myViolet3}{RGB}{242, 0, 255}
\definecolor{myGreenFlash}{RGB}{19, 237, 55}
\definecolor{myYellowNormal}{RGB}{156, 142, 5}
\definecolor{myRed8}{RGB}{210, 20, 20}
\definecolor{myRedG7}{RGB}{210, 140, 20}
\definecolor{myOrange0}{RGB}{255, 153, 0}
\definecolor{myBlackGrey}{RGB}{20, 20, 20}
%\newcommand{\cRef}[2]{\hyperref[#1]{\textcolor{myViolet}{#2}}}
\newcommand{\cRef}[2]{\hyperref[#1]{\textcolor{myBlackGrey}{#2}}}
...
%\newcommand{\ddc}{\textcolor{myCyan}{\footnotesize \DTMnow}}
%\newcommand{\DDCU}{\textcolor{myViolet2}{UPDATED}\xspace\textcolor{myCyan}{\footnotesize \DTMnow}}
%\newcommand{\ddcu}{\textcolor{myViolet2}{\footnotesize UPDATED}\xspace\textcolor{myCyan}{\footnotesize \DTMnow}}
%\newcommand{\DDCNEW}{\textcolor{myGreenFlash}{NEW}\xspace\textcolor{myCyan}{\footnotesize \DTMnow}}
%\newcommand{\ddcnew}{\textcolor{myGreenFlash}{\footnotesize NEW}\xspace\textcolor{myCyan}{\footnotesize \DTMnow}}
%\newcommand{\DDCNO}{\textcolor{myYellowNormal}{NO CHANGES}\xspace\textcolor{myCyan}{\footnotesize \DTMnow}}
%\newcommand{\ddcno}{\textcolor{myYellowNormal}{\footnotesize NO CHANGES}\xspace\textcolor{myCyan}{\footnotesize \DTMnow}}
%\newcommand{\DDCPU}{\textcolor{myViolet3}{PART. UP.}\xspace\textcolor{myCyan}{\footnotesize \DTMnow}}
%\newcommand{\ddcpu}{\textcolor{myViolet3}{\footnotesize PARTIALLY UPDATED}\xspace\textcolor{myCyan}{\footnotesize \DTMnow}}
%\newcommand{\DDCOLD}{\textcolor{myRed8}{DEPREC.}\xspace\textcolor{myCyan}{\footnotesize \DTMnow}}
%\newcommand{\ddcold}{\textcolor{myRed8}{\footnotesize DEPRECATED}\xspace\textcolor{myCyan}{\footnotesize \DTMnow}}
%\newcommand{\DDCIP}{\textcolor{myRedG7}{IN PROG.}\xspace\textcolor{myCyan}{\footnotesize \DTMnow}}
%\newcommand{\ddcip}{\textcolor{myRedG7}{\footnotesize IN PROGRESS}\xspace\textcolor{myCyan}{\footnotesize \DTMnow}}
%\newcommand{\DDCTR}{\textcolor{myOrange0}{TO REV.}\xspace\textcolor{myCyan}{\footnotesize \DTMnow}}
%\newcommand{\ddctr}{\textcolor{myOrange0}{\footnotesize TO REVIEW}\xspace\textcolor{myCyan}{\footnotesize \DTMnow}}
...
%  left=25mm,top=30mm,bottom=15mm,
%  headheight=7mm,
%  headsep=14mm,
...
\geometry{%
  a4paper, %body={150mm,220mm},
  left=20mm,right=20mm,top=30mm,bottom=15mm,
  headheight=7mm,
  headsep=14mm,
  marginparsep=4mm, marginparwidth=27mm
}
...
%\patchcmd{\@makechapterhead} {\vskip 80}{\vskip 40}{}{}
%\patchcmd{\@makeschapterhead}{\vskip 80}{\vskip 40}{}{} % for unnumbered chapters
%\makeatother

%\makeatletter
%\apptocmd{\chapter}{\vspace{-2cm}}
%\makeatother

%\makeatletter
%\pretocmd
%\pretocmd{\chapter}{\addtocontents{toc}{\vspace{-20cm}}}{}{}
