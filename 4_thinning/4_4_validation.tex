...
To do so, we chose the couple $(200 \; \mu m, -165 \; V)$ as the base search value.
Afterward, we swept across every possible couple for ST140 and chose the one with the closest area and correlation to the base ST200 couple.
Then, we did the same thing between ST140 and ST50, giving us the three following couples for each IC:
\begin{itemize}
