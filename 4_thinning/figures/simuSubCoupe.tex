...
\begin{figure}[H]
    ...
    \begin{subfigure}{17cm}
        \centering
        \includegraphics[width=17cm, trim={3cm 2cm 0 2.88cm}, clip]{4_thinning/figures/simuSubCoupeVoltageTripleWellApex140um.pdf}
        \caption{Cross-sectional view (Y-axis)}
        \label{fig:simuSubCoupeThick;subfig:yaxis}
    \end{subfigure}
    \begin{subfigure}{16cm}
        \centering
        \includegraphics[width=16cm, trim={1cm 3cm 0.5cm 2.85cm}, clip]{4_thinning/figures/simuSubBottomVoltageTripleWellApex140um.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{16cm}
        \centering
        \includegraphics[width=16cm, trim={1cm 3cm 0.5cm 2.85cm}, clip]{4_thinning/figures/simuSubBottomVoltageTripleWellApex60um.pdf}
        \caption{Probe point of view}
