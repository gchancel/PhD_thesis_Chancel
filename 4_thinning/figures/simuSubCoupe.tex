...
\begin{figure}[H]
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth, trim={3cm 2cm 0 2.88cm}, clip]{4_thinning/figures/simuSubCoupeVoltageTripleWellApex140um.pdf}
        \caption{Cross-sectional view (Y-axis)}
        \label{fig:simuSubCoupeThick;subfig:yaxis}
    \end{subfigure}
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth, trim={1cm 3cm 0.5cm 2.85cm}, clip]{4_thinning/figures/simuSubBottomVoltageTripleWellApex140um.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth, trim={3cm 4.8cm 0 5.5cm}, clip]{4_thinning/figures/simuSubCoupeVoltageTripleWellApex60um.pdf}
        \caption{Cross-sectional view (Y-axis)}
