...
Alongside, new systems have emerged and have massively grown these past decades: \cps and \iot.
...
I have identified two potential attacks on robust algorithms that have been implemented into actual integrated circuits.
...
A focused ion beam (FIB) can also be used to change the IC target internally by making electric connections that did not exist before, or destroy existing ones.
...
In this particular context, I examine in this chapter the current state of the art in relation to side-channel attacks and fault injection techniques, as outlined in the literature.
This allows me to explain the interests of the current work regarding hardware security.

In the first place, I will briefly discuss side-channel attacks.
Then, I will examine the various fault injection platforms commonly described.
Eventually, I will ponder the interests of BBI in this context.
