...
The \cRef{chap:1_intro}{first} chapter of this manuscript presents the global fault injection and specific Body Biasing Injection state of the art, mainly concerning side-channel attacks.
...
Subsequently, the \cRef{chap:4thinning}{fourth} discusses a common practice when performing fault injection: the thinning of integrated circuits' substrate.
