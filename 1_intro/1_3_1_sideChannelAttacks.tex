...
% END LAnguageTool
One of the simplest methods is to add electrical noise, which acts as a masking layer.
...
\begin{itemize}
    ...
    \item It requires only little equipment: probe and voltage amplifier;
