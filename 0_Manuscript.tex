...
\title{\protect\parbox{\textwidth}{\protect\centering Body biasing fault injection: enhancements, analysis, modeling, and simulation}}
\author{Geoffrey Chancel}
\date{2023-01-29}

\directorA{Philippe Maurine and Jean-Marc Gallière}
%\directorB{TO BE COMPLETED}

%\date`x{COMPILATION DATE: \DDC}
...
\doctoral{Information, Structures, and Systems}
\researchunit{LIRMM, University of Montpellier}
\specialisation{Automatic and Microelectronic Systems}
...
\jury{Jean-Luc Danger   }{Professor           }{Télécom-ParisTech               }{Examiner           }
\jury{Giorgio Di Natale }{Director of Research}{University of Grenoble Alpes    }{Examiner           }
\jury{Jean-Max Dutertre }{Professor           }{École des Mines de Saint-Étienne}{Examiner           }
\jury{Pascal Nouet      }{Professor           }{University of Montpellier       }{Examiner, President}
