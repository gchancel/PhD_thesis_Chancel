...
\sout{In this chapter, we first discussed the hardware and software commonly used for the practice of BBI, as well as presenting our hardware and software.
