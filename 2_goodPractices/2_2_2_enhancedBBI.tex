...
Eventually, I am able to draw conclusions on such improvements thanks to simulation results.
    ...
    Therefore, and because most high speed high voltage pulse generator are specified to be loaded with a precise impedance, I simply propose to connect a known load directly at the output of the generator.
