...
\section{\bbi platforms in the state-of-the-art \ddc}
...
\begin{itemize}
    ...
    \item A voltage pulse generator able to generate positive voltage pulses up to 100 V, with a maximum current of 2 A
    \item A custom-made probe, consisting of an SMA connector and a needle soldered to it
