...
ax[1].plot(badGND['iTime'][beginBad:endBad], badGND['iGND'][beginBad:endBad],
           lw = lw * scale)
ax[1].yaxis.set_major_formatter(form_amp)
ax[1].xaxis.set_major_formatter(form_sec)
ax[1].text(textposX,
           textposY,
...
ax[1].set_ylabel('$I_{GND}(t)$', fontsize = ySize, labelpad = yLabelPad, bbox = tBox,
                 rotation = yLabelRot)
# ax[1].vlines(x = 20e-9,
#              ymin = badGND['iGND'][beginBad:endBad].min() * 1.0,
#              ymax = badGND['iGND'][beginBad:endBad].max() * 1.0,
#              color = 'red',
#              lw = 1)

ax[0].plot(badGND['vTime'][beginBad:endBad], badGND['vPulse'][beginBad:endBad],
           lw = lw * scale)
ax[0].yaxis.set_major_formatter(form_volt)
ax[0].xaxis.set_major_formatter(form_sec)
ax[0].set_title("State of the art grounding",
...
ax[0].text(textposX,
           ...
           transform = ax[0].transAxes,
           fontsize = fSize * scale)
ax[0].set_ylabel('$V_{PULSE}(t)$', fontsize = ySize, labelpad = yLabelPad, bbox = tBox,
                 rotation = yLabelRot)
...
ax[3].plot(impGND['iTime'], impGND['iGND'],
           lw = lw * scale)
ax[3].yaxis.set_major_formatter(form_amp)
ax[3].xaxis.set_major_formatter(form_sec)
ax[3].text(textposX,
...
ax[2].plot(impGND['vTime'], impGND['vPulse'],
           lw = lw * scale)
ax[2].yaxis.set_major_formatter(form_volt)
ax[2].xaxis.set_major_formatter(form_sec)
ax[2].set_title("Ground bypass and impedance matching",
