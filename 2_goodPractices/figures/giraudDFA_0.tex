...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth, center,
        trim={14.9cm 0cm 0cm 0cm}, clip]{2_goodPractices/figures/aesFastImpGnd.pdf}
        \caption{FAM in an enhanced \bbi platform. 90 \% of the locations exhibits a correct behavior, while 10 \% shows Giraud's criterion incompatible behavior (multibyte faults). Five locations show single bit faults, useful for a Giraud single-bit fault attack.}
        \label{fig:giraudFSM}
    \end{subfigure}
