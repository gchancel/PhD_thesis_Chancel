...
%        \label{chap:2_goodPractices;sect:bbiInPractice;subsect:platformEvalCrit;subsubsect:icGndMeas}
    ...
    \end{itemize}
    These effects can also be observed on the IC ground current waveform (\textcolor{Purple}{putple}), as it is a mirror of the applied pulse due to the pure resistive nature of the IC in that model.
