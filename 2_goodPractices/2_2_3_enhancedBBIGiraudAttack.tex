...
%    \end{equation}
    ...
    \subsection{Preliminary attack experiments \ddcu}
        ...
        \end{itemize}
        The parameters have been chosen with the aim of minimizing the maximum voltage amplitude to avoid damaging the circuit.
    ...
    I then blindly tested every possibility to find the last two bytes, without exploiting the knowledge of the correct positions of the other secret key bytes, and I was able to retrieve them, thus allowing me to retrieve the entire AES secret key.
