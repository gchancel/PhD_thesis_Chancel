...
\label{concl_contrib}
    ...
    Because \bbi was not a very much documented fault injection method prior to my thesis, the platforms as a whole were not optimized.
    ...
    Similar to what has been done in the past for \lfi \cite{lfiThinning, lfiThinning2}, I conducted similar researches on \bbi concerning IC substrate thinning.
