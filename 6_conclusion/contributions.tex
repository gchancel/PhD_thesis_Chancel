...
%    \subsection{Improvements of existing \bbi platforms}
    ...
    In addition to this, with my original platform, the range between a normal behavior and a crash of the target was very tight, therefore preventing the execution of fault attacks.
