...
We are going to use this fault model, depicted in short in Fig. \ref{chap:5;fig:bbiSusc}, for the rest of this chapter.
It is important to note that this model was first introduced for EMFI \cite{emfiFF}.
%we described previously is depicted in Fig. \ref{chap:5;fig:bbiSusc} and was first introduced in \cite{emfiFF} for EMFI.

%\subsection{Charge extortion \ddc}
%\label{chap5:sect:chargeExtortion:subsect:chargeExtortion}
%As stated in the fault model, it is required, to create faults into the IC, to disturb the transistors enough during a specific time, called the "BBI susceptibility period" (Fig. \ref{chap:5;fig:bbiSusc}).
