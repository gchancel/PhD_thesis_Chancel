...
To identify the correct or develop a new one for \bbi, it is mandatory to simulate the logic behavior of transistors subjected to \bbi disturbances in an IC context.

To that end, I decided to extend the \scs simulation flow.
Indeed, the simulation flow I proposed in the previous chapter allowed me to finely analyze the effects of \bbi disturbances in IC substrates and power delivery networks.
...
Indeed, the model represents a hundred of logic gates solely with two resistors and four capacitors, which is their average electrical behavior.

The simulation flow follow-up consists in adding a few extra steps to the original flow, allowing to actually measure the impact on logic gates of \bbi.
