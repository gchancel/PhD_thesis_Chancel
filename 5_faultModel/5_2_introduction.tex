...
In the first place, I introduce these new simulation steps.
Then, I present the simulation results of such an addition.
Afterward, and thanks to the simulation results, I introduce a fault model which could explain the origin of faults in ICs subjected to \bbi.
Eventually, I take a step back on how this improves \bbi modeling and simulation, while bringing opportunities of improvement.
