...
Indeed, simulating the average behavior of a hundred of logic gates only with four resistors and four capacitors is immensely lighter than simulating the equivalent with BSIM (Berkeley Short-channel IGFET Mode) transistors.
...
Body biasing injection being less documented than EMFI, no model has yet been proposed to simulate ICs under BBI.
In this context, our motivations were to set up and evaluate reliable electrical models being able to predict and comprehend ICs behaviors.
...
Eventually, various model validation will be studied in order to verify their soundness.
