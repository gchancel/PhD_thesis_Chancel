...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.32\textwidth}
        ...
        \caption{Elementary substrate block 3D schematic with the default values used for our technology and the SPICE inout names.}
        \label{sfig_elemSub}
    \end{subfigure}
    \hfill
...
.ends elementary_bloc
        \end{Verbatim}
        \caption{Elementary substrate SPICE netlist description, with the inout names in accordance with Fig. \ref{sfig_elemSub}.}
