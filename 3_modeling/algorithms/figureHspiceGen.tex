...
%        \includegraphics[width=\textwidth]{3_modeling/figures/algoFigure8.pdf}
        \includegraphics[width=0.57\textwidth]{3_modeling/figures/ELEMSUB.png}
        \caption{Elementary substrate block 3D schematic with the values used for our technology and the SPICE in-out names.}
        \label{sfig_elemSub}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \begin{Verbatim}[frame=single,baselinestretch=1.15]
.subckt elementary_bloc D F L R Re U
R1 U N001 RH
R2 N001 D RH
R3 Re N001 RL
