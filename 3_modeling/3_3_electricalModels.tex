...
\textcolor{teal}{Ce qui suit doit être revu.}\textcolor{orange}{In addition to that, it offers flexibility thanks to easy user modifications directly into the generation algorithm parameters instead of netlist editing, which further reduces errors.
