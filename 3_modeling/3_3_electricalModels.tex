...
\textcolor{teal}{Ce qui suit doit être revu.}\textcolor{orange}{In addition to that, it offers flexibility tanks to easy user modifications directly in the generation algorithm parameters instead of netlist editing, which reduces further errors.
...
This was achieved using custom Python scripts using procedural generation.
The IC generation algorithm allows multiple settings to be modified in order to produce the required results, while also having some structural limitations.
