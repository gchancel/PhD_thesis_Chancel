    ...
    It is, according to my platform computational power, an IC with a reasonable size/calculation time ratio.
    ...
    \begin{itemize}
        ...
        \item Eventually, a mixed substrate IC, comprising at the same time \dwF and \twF \scs, to mimic a real IC, more specifically my platform microcontroller.
    \end{itemize}
    \begin{table}[ht]
        %    \footnotesize
        \centering
        ...
        \begin{tabular}{llrrr}
            ...
            $GND_{AVG}$     & Max. GND voltage drop      & 1 nV    			&  1 nV         	&  1.75 nV         	\\
            $VDD_{AVG}$     & Min. VDD Voltage drop      & 1.2 V    		&  1.2 V         	&  1.2 V         	\\
        \end{tabular}
    \end{table}
    ...
    One can observe very low steady current, which, according to the model, is consistent and should be expected.
