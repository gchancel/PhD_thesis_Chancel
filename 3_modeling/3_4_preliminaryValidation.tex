    ...
    \end{itemize}
    As I stated before, I performed the operating point and measured key values for each IC, which are presented in Table \ref{tab:basicOpPointScs}.
    \begin{table}[ht]
        %    \footnotesize
        \centering
    ...
    Indeed, as the transistors are modeled thanks to resistors and capacitor in parallel, and because the diodes are not conducting, there is no path for DC current without further circuit bias.
